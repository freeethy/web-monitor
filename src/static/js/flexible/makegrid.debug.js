(function(win, lib){
    ...
    function makeGrid(params) {
        ...
        var ratio = designUnit / designWidth * 10;     //rem转化
        var columnWidth = columnXUnit * ratio;        //列宽
        var gutterWidth = gutterXUnit * ratio;        //间距
        var edgeWidth = edgeXUnit * ratio;            //补丁
        ...
        var cssText = [
            ...
            '.' + className + ' [class="row"] {',
                'box-sizing:content-box;',
                'margin-left: -' + edgeWidth + 'rem;',
                'margin-right: -' + edgeWidth + 'rem;',
            '}',
            '.' + className + ':before,',
            '.' + className + ':after{',
                'content: " ";',
        ...
        for (var i = 1; i <= columnCount; i++) {
            cssText.push('.' + className + ' .col-' + i + ' {width: ' + Math.round(i/columnCount*10000)/100 + '%;}');
        }
